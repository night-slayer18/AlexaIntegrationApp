...
class TypingActivity : AppCompatActivity() {
    ...
    lateinit var layoutType : ConstraintLayout
    lateinit var layoutWin : ConstraintLayout
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutType = findViewById(R.id.main)
        layoutWin = findViewById(R.id.win)
        submit = findViewById(R.id.submit)
        next = findViewById(R.id.success)

        val wordList = listOf(
            "abandon", "ability", "absence", "academy", "accent", "accept", "access", "accident", "account", "accuracy",
            "achieve", "acquire", "address", "advance", "advice", "affect", "afford", "against", "airline", "airport",
            "alarm", "album", "alcohol", "alive", "allocate", "allow", "alone", "alphabet", "already", "amazing",
            "analyze", "ancestor", "ancient", "angel", "anger", "angle", "animal", "announce", "annual", "answer",
            "anxiety", "apartment", "apologize", "appeal", "appear", "apple", "appoint", "approve", "architect", "area",
            "argue", "arise", "army", "around", "arrange", "arrest", "arrive", "article", "artist", "ask",
            "aspect", "assemble", "assert", "assess", "assign", "assist", "assume", "assure", "athlete", "attract",
            "auction", "audit", "authentic", "author", "auto", "average", "avocado", "avoid", "awake", "aware",
            "away", "awesome", "awful", "awkward", "axis", "baby", "bachelor", "bacon", "badge", "bag",
            "bake", "balance", "ball", "bamboo", "banana", "banner", "bar", "barely", "bargain", "barrel",
            "base", "basic", "basket", "battle", "beach", "bean", "beauty", "because", "become", "beef",
            "before", "begin", "behave", "behind", "believe", "below", "belt", "bench", "benefit", "best",
            "betray", "better", "between", "beyond", "bicycle", "bid", "bike", "bind", "biology", "bird",
            "birth", "bitter", "black", "blade", "blame", "blanket", "blast", "bleak", "bless", "blind",
            "block", "blonde", "blood", "blossom", "blouse", "blue", "blur", "blush", "board", "boat",
            "body", "boil", "bomb", "bone", "bonus", "book", "boost", "border", "boring", "borrow",
            "boss", "bottom", "bounce", "box", "boy", "brave", "bread", "breeze", "brick", "bridge",
            "brief", "bright", "bring", "brisk", "broccoli", "broken", "bronze", "broom", "brother", "brown",
            "brush", "bubble", "buddy", "budget", "buffalo", "build", "bulb", "bulk", "bullet", "bundle",
            "bunker", "burden", "burger", "burst", "bus", "business", "busy", "butter", "butterfly", "button",
            "buyer", "buzz", "cabbage", "cabin", "cable", "cactus", "cage", "cake", "call", "calm",
            "camera","camp", "can", "canal", "cancel", "candy", "cannon", "canoe", "canvas", "canyon",
            "capable", "capital", "captain", "car", "carbon", "card", "cargo", "carpet", "carry", "cartoon",
            "carve", "case", "cash", "casino", "castle", "casual", "cat", "catalog", "catch", "category",
            "cattle", "caught", "cause", "caution", "cave", "ceiling", "celebrate", "cell", "cement", "center",
            ...
            "cram", "crane", "crash", "crate", "crawl", "crazy", "cream", "credit", "creek", "crew",
            ...
            "defy", "degree", "delay", "deliver", "demand", "demise", "denial", "dentist", "deny","deny", "depart",
            ...
            "fellow", "female", "fence", "fetch", "fever", "fiber", "fiction", "field", "figure",
            "file", "fill", "film", "filter", "final", "find", "fine", "finger", "finish", "fire",
            "firm", "first", "fiscal", "fish", "fit", "five", "fix", "flag", "flame", "flash",
            ...
            "horse", "hospital", "host", "hotel", "hour", "hover", "hub", "huge", "hug", "human", "humble", "humor", "hundred", "hungry", "hunt", "hurdle", "hurry", "hurt",
            ...
            "ritual", "rival", "river", "road", "roast", "robot", "robust", "rocket", "romance","roof", "rookie", "room", "rose", "rotate", "rough", "round", "route", "royal",
            ...
            "stand", "start", "state", "stay", "steak", "steel", "stem", "step","stereo", "stick", "still", "sting", "stock", "stomach", "stone", "stool", "story", "stove",
        ...
        submit.setOnClickListener {
            if (editText.text.toString().trim().equals(randomWord)) {
                layoutType.visibility = View.GONE
                layoutWin.visibility = View.VISIBLE
            }else if (editText.text.toString().trim().equals("")) {
                Toast.makeText(this,"Start Typing",Toast.LENGTH_SHORT).show()
            }
            else {
                editText.setBackgroundResource(R.drawable.wrong_math)
                editText.setTextColor(Color.WHITE)
                Handler().postDelayed({
                    editText.setBackgroundResource(R.drawable.maths)
